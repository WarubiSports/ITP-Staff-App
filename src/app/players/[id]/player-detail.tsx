...
import { PerformanceTestsCard } from '@/components/player-detail/PerformanceTestsCard'
import { CollegePathwayCard } from '@/components/player-detail/CollegePathwayCard'
import { WellnessCard } from '@/components/player-detail/WellnessCard'
import { TrainingLoadsCard } from '@/components/player-detail/TrainingLoadsCard'
import { DevelopmentFocusCard } from '@/components/player-detail/DevelopmentFocusCard'
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <DevelopmentFocusCard playerId={player.id} focusNotes={focusNotes} />

          <PerformanceTestsCard playerId={player.id} physicalTests={physicalTests} />
          ...
          <CollegePathwayCard playerId={player.id} playerPlayerId={player.player_id} playerFirstName={player.first_name} playerLastName={player.last_name} collegeTargets={collegeTargets} outreachEntries={outreachEntries} />

          <WellnessCard wellnessLogs={wellnessLogs} />

          <TrainingLoadsCard trainingLoads={trainingLoads} />
