...
export function AddMedicalAppointmentModal({ isOpen, onClose, players, onSuccess }: AddMedicalAppointmentModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Schedule Medical Appointment" size="lg">
